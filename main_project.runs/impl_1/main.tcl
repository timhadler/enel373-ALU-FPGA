...
set rc [catch {
  ...
  set_property ip_repo_paths d:/ENEL373/Project/mine/main_project.cache/ip [current_project]
  set_property ip_output_repo d:/ENEL373/Project/mine/main_project.cache/ip [current_project]
  add_files -quiet D:/ENEL373/Project/mine/main_project.runs/synth_1/main.dcp
